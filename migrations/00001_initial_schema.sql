...
CREATE TABLE engagements (
	...
	CONSTRAINT engagements_pkey PRIMARY KEY (name)
);
CREATE TABLE events (
	...
	patch varchar NULL,
	is_main_event bool DEFAULT true NOT NULL,
	uses_medals bool DEFAULT false NOT NULL,
...
CREATE TABLE timings (
	...
	CONSTRAINT timings_pkey PRIMARY KEY (key)
);
CREATE TABLE users (
	id serial4 NOT NULL,
...
CREATE TABLE achievements (
	...
	CONSTRAINT achievements_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id)
);
...
CREATE TABLE "characters" (
	...
	CONSTRAINT characters_event_id_fkey FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE oauths (
	...
	refresh_expiry timestamptz DEFAULT '1970-01-01 01:00:00+01'::timestamp with time zone NOT NULL,
...
CREATE TABLE objectives (
	...
	number_field_explanation text NULL,
...
CREATE TABLE stash_changes (
	...
	"timestamp" timestamptz NULL,
	id serial4 NOT NULL,
	CONSTRAINT stash_changes_pk PRIMARY KEY (id),
...
CREATE TABLE character_pobs (
	...
	dps int8 DEFAULT 0 NOT NULL,
	ehp int4 DEFAULT 0 NOT NULL,
	phys_max_hit int4 DEFAULT 0 NOT NULL,
	ele_max_hit int4 DEFAULT 0 NOT NULL,
	hp int4 DEFAULT 0 NOT NULL,
	mana int4 DEFAULT 0 NOT NULL,
	es int4 DEFAULT 0 NOT NULL,
	armour int4 DEFAULT 0 NOT NULL,
	evasion int4 DEFAULT 0 NOT NULL,
	xp int8 DEFAULT 0 NOT NULL,
	movement_speed int4 DEFAULT 0 NOT NULL,
	items _int2 DEFAULT '{}'::smallint[] NOT NULL,
...
CREATE TABLE guild_stash_tabs (
	...
	priority_fetch bool DEFAULT false NOT NULL,
...
CREATE TABLE guilds (
	...
	tag varchar NULL,
	event_id int4 NOT NULL,
	CONSTRAINT guilds_pkey PRIMARY KEY (id, team_id, event_id),
	CONSTRAINT fk_guilds_event_id FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE,
...
CREATE TABLE item_wishes (
	...
	build_enabling bool DEFAULT false NOT NULL,
	team_id int4 NOT NULL,
	extra text DEFAULT ''::text NOT NULL,
	CONSTRAINT item_wishes_pkey PRIMARY KEY (id),
	CONSTRAINT item_wishes_team_id_fkey FOREIGN KEY (team_id) REFERENCES teams(id) ON DELETE CASCADE,
	CONSTRAINT item_wishes_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
);
CREATE TABLE objective_matches (
	...
	CONSTRAINT objective_matches_stash_changes_fk FOREIGN KEY (stash_change_id) REFERENCES stash_changes(id),
	CONSTRAINT objective_matches_teams_fk FOREIGN KEY (team_id) REFERENCES teams(id) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT objective_matches_users_fk FOREIGN KEY (user_id) REFERENCES users(id)
);
...
CREATE TABLE objective_scoring_presets (
	...
	CONSTRAINT objective_scoring_presets_pkey PRIMARY KEY (objective_id, scoring_preset_id),
...
CREATE INDEX objective_scoring_presets_scoring_preset_id_idx ON objective_scoring_presets USING btree (scoring_preset_id);
