...
// @Tags Timing
// @Produce json
// @Success 200 {object} map[repository.TimingKey]int64
// @Router /timings [get]
...
// @Accept json
// @Produce json
// @Param timings body []Timing true "List of timing configurations"
// @Success 204
// @Router /timings [put]
...
type Timing struct {
	Key        repository.TimingKey `json:"key"`
	DurationMs int64                `json:"duration_ms"`
}

func toTiming(t Timing) *repository.Timing {
