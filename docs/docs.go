...
const docTemplate = `{
        ...
        "schemas": {
            ...
            "ItemJewelData": {
                "properties": {
                    ...
                    "subgraph": {
                        "$ref": "#/components/schemas/ItemJewelDataSubgraph"
                    },
                    "type": {
                        "type": "string"
                    }
            ...
            "PassiveNode": {
                "properties": {
                    ...
                    "expansionJewel": {
                        "$ref": "#/components/schemas/PassiveNodeExpansionJewel"
                    },
                    "flavourText": {
                        "items": {
                            "type": "string"
                    ...
                    "masteryEffects": {
                        "items": {
                            "$ref": "#/components/schemas/PassiveNodeMasteryEffect"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "StashTab": {
                "properties": {
                    "children": {
                        "items": {
                            "$ref": "#/components/schemas/StashTab"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "Timing": {
                "properties": {
                    ...
                    "key": {
                        "$ref": "#/components/schemas/TimingKey"
                    }
                },
                "required": [
                    "description",
    ...
    "paths": {
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/EngagementAdd",
                                        "summary": "engagement",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/ConditionMappings"
                                }
                            }
                        },
                        "description": "OK"
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/ObjectiveValidation"
                                    },
                                    "type": "array"
                                }
                            }
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/ScoreDiff"
                                    },
                                    "type": "array"
                                }
                            }
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/ExtendedSignup"
                                    },
                                    "type": "array"
                                }
                            }
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/TwitchStream"
                                    },
                                    "type": "array"
                                }
                            }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/TeamSubmissionCreate",
                                        "summary": "teamSubmissionCreate",
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/SortedUser"
                                    },
                                    "type": "array"
                                }
                            }
        ...
        "/events/{event_id}/teams/{team_id}/item_wishes": {
            "get": {
                "description": "Get item wishes for a team in an event",
                "operationId": "GetItemWishesForTeam",
                "parameters": [
                    {
                        "description": "Event ID",
                        "in": "path",
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/ItemWish"
                                    },
                                    "type": "array"
                                }
                            }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/CreateItemWish",
                                        "summary": "item_wish",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/UpdateItemWish",
                                        "summary": "item_wish",
                                        "description": "Item Wish"
                                    }
                                ]
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/TeamSuggestion"
                                    },
                                    "type": "array"
                                }
                            }
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/AtlasProgression"
                                    },
                                    "type": "array"
                                }
                            }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "items": {
                                            "$ref": "#/components/schemas/TimingCreate"
                                        },
                                        "title": "timings",
                                        "type": "array"
                                    }
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/CharacterStat"
                                    },
                                    "type": "array"
                                }
                            }
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/GuildStashChangelog"
                                    },
                                    "type": "array"
                                }
                            }
            ...
            "post": {
                ...
                "requestBody": {
                    "content": {
                        "application/json": {
                            "schema": {
                                "$ref": "#/components/schemas/GuildStashChangeResponse",
                                "summary": "guildStashChanges",
                ...
                "responses": {
                    "201": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/AddGuildStashHistoryResponse"
                                }
                            }
                        },
                        "description": "Created"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/GuildStashLogTimestampResponse"
                                }
                            }
                        },
                        "description": "OK"
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/GuildStashTab"
                                    },
                                    "type": "array"
                                }
                            }
        ...
        "/{eventId}/teams/{teamId}/guild-stash/{stash_id}": {
            "get": {
            ...
            "patch": {
                ...
                "requestBody": {
                    "content": {
                        "application/json": {
                            "schema": {
                                "$ref": "#/components/schemas/TabSwitchRequest",
                                "summary": "body",
                                "description": "Request body"
                            }
                        }
        ...
        "/{eventId}/teams/{teamId}/guild-stash/{stash_id}/update": {
            "post": {
